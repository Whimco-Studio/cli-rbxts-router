class RbxtsRouter < Formula
    ...
    homepage "https://github.com/Whimco-Studio/cli-rbxts-router/"
    url "https://github.com/Whimco-Studio/cli-rbxts-router/releases/download/v1.0.1/rbxts-router-macos-arm64"
